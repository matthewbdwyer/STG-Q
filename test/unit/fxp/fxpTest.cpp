...
std::string helper(std::stringstream &stream){
    ...
    std::string dict_path = stgq_home_path+"/test/unit/fxp/dict.json";
    const char *dict = dict_path.c_str(); 

    FXPPrinter fxp(outputStream, 2);
    fxp.print(ast.value(), dict);
...
TEST_CASE("FXP Table: locals", "[FXP_Dict]") {
    ...
    std::size_t found = output.find("(declare-fun X_float () (_ SFXP 32 5))");
...
TEST_CASE("No_var", "[No_var]") {
    ...
    std::size_t found = output.find("false");
    REQUIRE(found!=std::string::npos);
}
...
TEST_CASE("Binary_var", "[Binary_var]") {
    ...
    std::size_t found = output.find("(declare-fun X_bin () (_ SFXP 1 0))");
    REQUIRE(found!=std::string::npos);
}
...
TEST_CASE("Int_constant", "[Int]") {
    ...
    std::size_t found = output.find("((_ sfxp 0) #b00000000000000000000000000000001");
    REQUIRE(found!=std::string::npos);
}
...
TEST_CASE("fneg", "[Unary_Intrinsic]") {
    ...
    std::size_t found = output.find("sfxp.neg saturation X_float");
    REQUIRE(found!=std::string::npos);
}
...
TEST_CASE("add", "[Binary_Intrinsic]") {
    ...
    std::size_t found = output.find("sfxp.add saturation X_int Y_int");
    REQUIRE(found!=std::string::npos);
...
TEST_CASE("sub", "[Binary_Intrinsic]") {
    ...
    std::size_t found = output.find("sfxp.sub saturation X_int Y_int");
    REQUIRE(found!=std::string::npos);
...
TEST_CASE("mul", "[Binary_Intrinsic]") {
    ...
    std::size_t found = output.find("sfxp.mul saturation roundDown X_int Y_int");
    REQUIRE(found!=std::string::npos);
...
TEST_CASE("sdiv", "[Binary_Intrinsic]") {
    ...
    std::size_t found = output.find("sfxp.div saturation roundDown X_int Y_int");
    REQUIRE(found!=std::string::npos);
}
...
TEST_CASE("fadd", "[Binary_float_Intrinsic]") {
    ...
    std::size_t found = output.find("sfxp.add saturation X_float Y_float");
    REQUIRE(found!=std::string::npos);
...
TEST_CASE("fsub", "[Binary_float_Intrinsic]") {
    ...
    std::size_t found = output.find("sfxp.sub saturation X_float Y_float");
    REQUIRE(found!=std::string::npos);
...
TEST_CASE("fmul", "[Binary_float_Intrinsic]") {
    ...
    std::size_t found = output.find("sfxp.mul saturation roundDown X_float Y_float");
    REQUIRE(found!=std::string::npos);
...
TEST_CASE("fdiv", "[Binary_float_Intrinsic]") {
    ...
    std::size_t found = output.find("sfxp.div saturation roundDown X_float Y_float");
    REQUIRE(found!=std::string::npos);
}
...
TEST_CASE("slt", "[Binary_Comparison]") {
    ...
    std::size_t found = output.find("sfxp.lt X_int X_int");
    REQUIRE(found!=std::string::npos);
...
TEST_CASE("sle", "[Binary_Comparison]") {
    ...
    std::size_t found = output.find("sfxp.leq X_int X_int");
    REQUIRE(found!=std::string::npos);
...
TEST_CASE("sgt", "[Binary_Comparison]") {
    ...
    std::size_t found = output.find("sfxp.gt X_int X_int");
    REQUIRE(found!=std::string::npos);
...
TEST_CASE("sge", "[Binary_Comparison]") {
    ...
    std::size_t found = output.find("sfxp.geq X_int X_int");
    REQUIRE(found!=std::string::npos);
...
TEST_CASE("olt", "[Binary_Comparison]") {
    ...
    std::size_t found = output.find("sfxp.lt X_float X_float");
    REQUIRE(found!=std::string::npos);
...
TEST_CASE("ole", "[Binary_Comparison]") {
    ...
    std::size_t found = output.find("sfxp.leq X_float X_float");
    REQUIRE(found!=std::string::npos);
...
TEST_CASE("ogt", "[Binary_Comparison]") {
    ...
    std::size_t found = output.find("sfxp.gt X_float X_float");
    REQUIRE(found!=std::string::npos);
...
TEST_CASE("oge", "[Binary_Comparison]") {
    ...
    std::size_t found = output.find("sfxp.geq X_float X_float");
    REQUIRE(found!=std::string::npos);
