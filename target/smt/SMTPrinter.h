...
/*! \class SMTPrinter
 *  \brief A collection of routines implementing the conversion of path conditions (.stg files) into smt2 files (int/real).
*/

class SMTPrinter: public ConstraintVisitor {
public:
  SMTPrinter() : os(std::cout), indentSize(2) {}
  SMTPrinter(std::ostream &os, int indentSize ) : 
